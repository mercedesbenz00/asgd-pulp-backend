...
exports.update = async (id, data) => {
  ...
  return await FeedOperationTransaction.update(objectToUpdate, {
    where: { id: id },
  });
};
...
exports.getLatestTransaction = async (lineCode, orderType) => {
  return await FeedOperationTransaction.findOne({
    where: { line_code: lineCode, order_type: orderType },
    order: [["transaction_time", "DESC"]],
  });
};
