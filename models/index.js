...
db.productPulpTypeGroup = require("../models/productPulpTypeGroup.model.js")(
  sequelize,
  Sequelize
);
db.feedingLine = require("../models/feedingLine.model.js")(
  sequelize,
  Sequelize
);
...
db.feedOperationTransaction =
  require("../models/feedOperationTransaction.model.js")(sequelize, Sequelize);
